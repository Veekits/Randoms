...
output_file = 'C:/Users/VMUKITA/OneDrive - Goodlife Pharmacy/Desktop/MY PROJECTS/Randoms/Web Scraping/SPECIAL ORDER TEMPLATE.xlsx'
...
def extract_codes_and_quantities(directory, output_file):
    ...
    result_df = pd.DataFrame(columns=['Folder', 'File', 'Code', 'Quantity'])
        ...
        try:
            ...
            if code_columns and quantity_columns:
                ...
                for code, quantity in non_empty_entries:
                    ...
                    result_df = result_df.append({'Folder': folder_name, 'File': file_name, 'Code': code, 'Quantity': quantity}, ignore_index=True)
    ...
    sheet = workbook['SPECIAL ORDER TEMPLATE.xlsx']

    # Write the result DataFrame to the Excel sheet
...
extract_codes_and_quantities(base_dir, output_file)
